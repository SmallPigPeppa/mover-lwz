...
def create_mover_input(data_root,save_root, rec_idx):
    ...
    with h5py.File(os.path.join(save_root,rec_idx, f'{rec_idx}.hdf5'), 'w') as f:
        f.create_dataset('skeleton_joints', data=kpts_smplx)
...
if __name__ == "__main__":
    ...
    data_root = '/mnt/mmtech01/dataset/vision_text_pretrain/gta-im/FPS-30'
    save_root = '/mnt/mmtech01/usr/liuwenzhuo/code/mover-lwz-fit3d-smpl-all/mover-input/FPS-30'
