...
if __name__ == "__main__":
    ...
    parser.add_argument('--out_dir', type=str, default='/root/code/mover/preprocess/out_data', help='an integer for the accumulator')
    parser.add_argument('--root_dir', type=str, default='/root/code/mover/preprocess/input_data',help='an integer for the accumulator')
