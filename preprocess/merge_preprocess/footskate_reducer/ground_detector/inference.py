...
def parse_args():
    ...
    # Data
    parser.add_argument('--vid_path', default='/is/cluster/hyi/workspace/HCI/footskate_reducer/demo/dance.mp4')
    parser.add_argument('--op_path', default='/is/cluster/hyi/workspace/HCI/footskate_reducer/demo/dance.npy')
    ...
    # Logging
    parser.add_argument('--out_dir', default='/is/cluster/hyi/workspace/HCI/footskate_reducer/ground_detector/demo', help='Path to save models and logs')
...
def main():
    ...
    for _ in range(steps_per_epoch):
        ...
        preds.append(pred)
        ori_preds_prob.append(pred_prob)

    preds = np.concatenate(preds, axis=0)
    ori_preds_prob = np.concatenate(ori_preds_prob, axis=0)
    ...
    save_name = save_name.replace('.npy', '_ground_ori_prob.npy')
    np.save(save_name, ori_preds_prob)
