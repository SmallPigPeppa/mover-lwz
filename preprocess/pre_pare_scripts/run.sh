...
echo $1
# ! modify
# DATA_FOLDER='/ps/scratch/hyi/HCI_dataset/holistic_scene_human/test_imgs'
# OUTPUT_FOLDER="/ps/scratch/hyi/HCI_dataset/holistic_scene_human/20200223_experiments/mv_smplifyx_input_withPARE" 
# JSON_FOLDER="/ps/scratch/hyi/HCI_dataset/holistic_scene_human/openpose_result"
