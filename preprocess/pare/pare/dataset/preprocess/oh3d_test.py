...
def oh3d_test_extract(dataset_path, out_path):

    json_f = 'test/annots.json'
    ...
    for key,ann in tqdm(annots.items()):
        ...
        imgnames_.append('test/' + ann['img_path'].replace("\\", '/'))
    ...
    out_file = os.path.join(out_path, f'3doh_test.npz')
